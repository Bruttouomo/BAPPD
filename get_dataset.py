from label_inference_attacks.Code.datasets import bc_idc, cifar10, cifar100, cinic10, yahoo, tiny_image_net, criteo, breast_cancer_wisconsin,cora, citeseer, pubmed
...
def get_dataset_setup_by_name(dataset_name):
    dict_dataset_setup = {
        ...
        'Cora': cora.CoraSetup(),
        'Citeseer': citeseer.CiteseerSetup(),
        'PubMed': pubmed.PubMedSetup()
    }
